...
<!-- 维保信息 -->
  <div>
    ...
    <el-table :data="returnData" border style="width: 100%">
      ...
      <el-table-column prop="department_name" label="资产名称"></el-table-column>
      <el-table-column prop="company_name" label="供应商"></el-table-column>
      <el-table-column prop="personnel_name" label="联系方式"></el-table-column>
      <el-table-column prop="collar_time" label="维保到期时间">
        <template slot-scope="scope">{{scope.row.collar_time | date}}</template>
      </el-table-column>
      <el-table-column prop="personnel_name" label="资产类型"></el-table-column>
      <el-table-column prop="personnel_name" label="联系方式"></el-table-column>
      <el-table-column prop="personnel_name" label="使用人"></el-table-column>
      <el-table-column prop="personnel_name" label="使用公司"></el-table-column>
      <el-table-column prop="personnel_name" label="使用部门"></el-table-column>
